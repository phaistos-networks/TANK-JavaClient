...
class TestApp {
  public static void main(String[] args) throws Exception {
    ...
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 1".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 2".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 3".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 4".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 5".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 6".getBytes()));
    publish.publishMessage("foo", 1, new TankMessage("Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 7".getBytes()));
