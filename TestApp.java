...
class TestApp {
  public static void main(String[] args) throws Exception {
    ...
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 1"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 2"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 3"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 4"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 5"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 6"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 7"));
    publish.publishMessage("foo", 1, new TankMessage(
        "Μία μακρουλή γραμμή για να περάσουμε το όριο των 1024 μπάιτς στο πιτς φιτιλι 8"));
    publish.publishMessage("foo", 1, new TankMessage(
